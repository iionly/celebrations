...
$js = "onChange=\"MM_jumpMenu('parent',this, $month)\"";
...
$area3 .= $divbox . elgg_view('input/dropdown', array('name' => 'input_filterid', 'options_values'=>filterlist($user_guid), 'value'=>$filterid, 'js'=>$js)) . '</div>';
